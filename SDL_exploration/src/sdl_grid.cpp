// source: https://github.com/catsocks/sdl-grid/blob/master/main.c#L2

#include <SDL2/SDL.h>

int main() {
	
	// investigate why these values look a little weird
	...
	// Place the grid cursor in the middle screen
	...
	// The cursor ghost is a cursor that always shows in the cell beloow the mouse cursor
	SDL_Rect grid_cursor_ghost = {grid_cursor.x, grid_cursor.y, grid_cell_size, grid_cell_size};


	// Dark theme
	SDL_Color grid_background = {22, 22, 22, 255} ; // Barley black
		...
		while(SDL_PollEvent(&event)) {
			...
			case SDL_KEYDOWN:
				...
				case SDLK_RIGHT:
					grid_cursor.x += grid_cell_size;
					break;
				} // end of event.key.keysym.sym switch
				break;
